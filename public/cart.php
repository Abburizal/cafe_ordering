    ...
    // Ambil ID meja untuk tampilan, jika ada
    $table_id = $_SESSION['table_id'] ?? 'Tidak Ditemukan';
    ?>
    <!doctype html>
    <html lang="id">
    <head>
    ...
    <div class="max-w-4xl mx-auto bg-white p-6 sm:p-8 rounded-2xl shadow-2xl">
        ...
        Anda sedang memesan untuk Meja: <strong class="text-indigo-900"><?= e($table_id) ?></strong>
        </div>
